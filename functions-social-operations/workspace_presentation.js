...
function zone(profile={},workspace={},operations={}){
 for(const value of [operations.timeZone,operations.settings?.timeZone,workspace.timeZone,profile.timeZone,profile.timezone,profile.businessHours?.timeZone]){
