...
assert.deepEqual(Object.keys(businessProfile).sort(), ["getBusinessOnboarding", "saveBusinessOnboarding", "searchBusinessProfilePlaces", "getBusinessServiceAreaSuggestions", "saveBusinessGrowthProfile", "listBusinessWorkspaceRecordIds", "prepareInvitedBusinessAccount", "getBusinessTeam", "inviteBusinessTeamMember", "acceptBusinessTeamInvitation", "updateBusinessTeamMember", "getBusinessWorkspaceContext", "selectBusinessWorkspace", "auditBusinessCampaignDraft"].sort());
