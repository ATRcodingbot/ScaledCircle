...
const names = ["inspectMetaGrowthRuntimeV1", "runMetaGrowthPublisherV1", "runMetaGrowthMeasurementsV1", "reconcileMetaGrowthPublicationV1", "setMetaGrowthPublishingStateV1"];
...
if (JSON.stringify(actual) !== JSON.stringify([...names].sort()) ||
    /META_SOCIAL_APP_SECRET|YOUTUBE_SOCIAL_CLIENT_SECRET|X_SOCIAL_CLIENT_SECRET|x_first_publish/.test(built)) {
