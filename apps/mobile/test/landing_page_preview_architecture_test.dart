...
void main() {
  ...
  test('desktop preview uses the full funnel width and responsive composition', () {
  ...
  test('preview includes conversion fields, repeated CTA, and safe disclosure', () {
    for (final field in ['Name', 'Email or phone', 'How can we help?']) {
      expect(source, contains("'$field'"));
    }
    expect(source, contains('No obligation is created by sending a request.'));
