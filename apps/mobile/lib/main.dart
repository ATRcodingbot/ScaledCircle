...
class ScaledCircleApp extends StatelessWidget {
  ...
  static Route<dynamic> _generateRoute(RouteSettings settings) {
    ...
    if (route?.path == AppRoutes.businessBrandAssets) {
      return MaterialPageRoute(
        settings: settings,
        builder: (_) => ProtectedRouteGate(
    ...
    if (route?.path == AppRoutes.businessPhysicalMarketing) {
      return MaterialPageRoute(
        settings: settings,
        builder: (_) => ProtectedRouteGate(
    ...
    if (route?.path == AppRoutes.businessSocialOperations) {
      return MaterialPageRoute(
        settings: settings,
        builder: (_) => ProtectedRouteGate(
    ...
    if (route?.path == AppRoutes.completeBusinessProfile) {
      return MaterialPageRoute(
        settings: settings,
