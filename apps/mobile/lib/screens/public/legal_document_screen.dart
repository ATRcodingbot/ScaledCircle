...
_Document _document(LegalDocumentKind kind) => switch (kind) {
  ...
  LegalDocumentKind.scalerTerms => const _Document(
    ...
    [
      ...
      _Section('Status and legal review', ['ScaledCircle intends role-specific participation rather than employment promises, but worker classification, tax, and contractor terms require professional legal review. Nothing here guarantees jobs, hours, income, assignment volume, or payout timing.'], links: [('Support', AppRoutes.support)]),
    ],
  ),
