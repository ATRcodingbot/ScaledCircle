...
class MaterialDistributionCampaignScreen extends StatefulWidget {
  ...
  @override
  State<MaterialDistributionCampaignScreen> createState() =>
      _MaterialDistributionCampaignScreenState();
}

class _MaterialDistributionCampaignScreenState
    extends State<MaterialDistributionCampaignScreen> {
  ...
  late CampaignType _campaignType;
  ...
  static const Set<CampaignType> _distributionCampaignTypes = {
    CampaignType.flyerDistribution,
    CampaignType.doorHangerDistribution,
    CampaignType.businessCardDistribution,
  };

  static const Set<CampaignType> _marketingMaterialCampaignTypes = {
    CampaignType.flyerDistribution,
    CampaignType.doorHangerDistribution,
    CampaignType.businessCardDistribution,
    CampaignType.yardSignInstallation,
  };
  ...
  bool get _requiresExactLocations {
    return _campaignType == CampaignType.yardSignInstallation ||
        _campaignType == CampaignType.dumpRun ||
        _campaignType == CampaignType.eventMarketing;
  }
  ...
  String _campaignTypeLabel(CampaignType type) {
    switch (type) {
  ...
  String _campaignTypeDescription(CampaignType type) {
    switch (type) {
      case CampaignType.flyerDistribution:
      ...
      case CampaignType.yardSignInstallation:
        return 'Install signs at exact addresses with GPS photo verification.';

      case CampaignType.dumpRun:
        return 'Pickup, haul, and disposal with proof of completion.';

      case CampaignType.eventMarketing:
        return 'Send Scalers to events or venues for local promotion.';

      case CampaignType.neighborhoodCanvassing:
        return 'GPS verified neighborhood outreach.';

      case CampaignType.yardCleanup:
        return 'Cleanup work with before and after photo verification.';
      case CampaignType.junkRemoval:
        return 'Remove unwanted items with pickup, hauling, and completion verification.';
    }
  }
      ...
      body: SafeArea(
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              Text(
                'Create ${_campaignTypeLabel(_campaignType)}',
              ...
              Text(
                _campaignTypeDescription(_campaignType),
