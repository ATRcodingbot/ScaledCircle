...
class WeatherOpportunityAnalysisScreen extends StatefulWidget {
  const WeatherOpportunityAnalysisScreen({super.key});

  @override
  State<WeatherOpportunityAnalysisScreen> createState() =>
      _WeatherOpportunityAnalysisScreenState();
}

class _WeatherOpportunityAnalysisScreenState
    extends State<WeatherOpportunityAnalysisScreen> {
