    ...
    try {
      ...
      if (areaSaved == true) {
        ...
        ScaffoldMessenger.of(context)
          ...
          SnackBar(
            content: Text(
              '$zoneName was added to the campaign.',
            ),
          ),
        );
      } else {
