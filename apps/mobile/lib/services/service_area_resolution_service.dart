  ...
  ServiceAreaResolution fromKnownPlace({
    ...
    return ServiceAreaResolution(
      ...
      data: {
        ...
        'geometry': geometry,
        'geometryParts': suggestion.geometryParts,
        'geometryType': suggestion.geometryType,
        'geographyType': suggestion.geographyType,
        'geographicId': suggestion.geographicId,
        'sourceVintage': suggestion.sourceVintage,
