...
| Public | Legal/consent surface | signup/footer/action prompts/tracking disclosure | `legal-core` + consent-gated funding/application/assignment; tracking gate deferred | PARTIAL | FIX BEFORE LAUNCH | P0 | 334 backend; 292 Flutter + 1 skip; Firestore 20/20; Storage 6/6 | Hosted consent actor QA passed staging | Web/mobile | High | High | Production rollout pending; location gate deferred; attorney review remains | Curate coordinated production rollout; retain professional review gate |
