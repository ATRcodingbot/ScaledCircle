...
## P0-6 — Public trust/legal consent authority — ENGINEERING LIVE + VERIFIED; ATTORNEY REVIEW OPEN
...
- Production status (2026-08-25): the two `legal-core` callables, `application-core:applyToCampaign`, the two consent-gated assignment callables, the consent-gated funding callable, exact Hosting bundle, and server-only application-create Rule are live and verified. Signed-out callables fail with 401; signed-out direct application create fails with 403. No financial or worker mutation was used for QA.
- Remaining engineering boundary: new-session location-notice enforcement remains deferred to the separately gated worker-lifecycle promotion.
...
Official launch remains blocked by P0-1 physical Android proof, P0-2 worker-lifecycle production parity, P0-3 worker cash-out, and the professional attorney-review portion of P0-6. P0-6 consent engineering is live and production-verified; location consent remains coupled to P0-2. P0-4/P0 Batch 1, P0-7/P0 Batch 2, and P0-5/P0 Batch 3 are also live and production-verified. Three implementation P0s remain, plus the documented professional legal gate.
